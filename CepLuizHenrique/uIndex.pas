...
type
  ...
  private
    ...
    procedure EnviarEmail(email:string);
  public
    { Public declarations }
  end;
...
procedure TIndex.EnviarEmail(email:string);
var
...
begin
  ...
  Screen.Cursor := crSQLWait;
  EnviarEmail(EdEmail.Field.Value);
  Screen.Cursor := crDefault;
  Application.MessageBox('Informação dados gravados com sucesso. ','Index',MB_OK+ MB_ICONEXCLAMATION);
